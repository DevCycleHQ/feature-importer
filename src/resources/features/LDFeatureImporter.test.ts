...
describe("LDFeatureImporter", () => {
  describe("getFeaturesToImport", () => {
    ...
    test("with default config options", async () => {
      ...
      mockLD.getAllFeatureFlagsForProject.mockResolvedValue(
        mockLDFeaturesFlags
      );
                    ...
                    filters: [
                      {
                        ...
                        type: "user",
                        values: featureRule.clauses[0].values,
                      },
                    ],
                    operator: "and",
                  },
                    ...
                    filters: [
                      {
                        comparator: "=",
                        type: "audienceMatch",
                        _audiences: [mockAudience["seg-1-production"]._id],
                      },
                    ],
                    operator: "and",
                  },
  ...
  describe("importFeatureConfigs", () => {
    ...
    test("create a feature config for create feature", async () => {
      ...
      mockDVC.updateFeatureConfigurations.mockResolvedValue(
        featureConfigResponse
      );
