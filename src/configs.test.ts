...
describe('validateKey', () => {
    describe('Valid Keys', () => {
        ...
        test('should accept uppercase alphanumeric keys', () => {
            expect(() =>
                validateKey('MYPROJECTKEY', 'testKey', true),
            ).not.toThrow()
            expect(() =>
                validateKey('PROJECT123', 'testKey', true),
            ).not.toThrow()
        ...
        test('should accept mixed case alphanumeric keys', () => {
            ...
            expect(() => validateKey('aBc123XyZ', 'testKey', false)).toThrow()
            expect(() =>
                validateKey('CamelCaseKey', 'testKey', false),
            ).toThrow()
        })
        ...
        test('should accept keys with hyphens', () => {
            ...
            expect(() =>
                validateKey('My-Project-Key', 'testKey', true),
            ).not.toThrow()
        ...
        test('should accept keys with underscores', () => {
            ...
            expect(() =>
                validateKey('My_Project_Key', 'testKey', false),
            ).toThrow()
            expect(() =>
                validateKey('UPPER_CASE_KEY', 'testKey', true),
            ).not.toThrow()
        })
        ...
        test('should accept keys with periods', () => {
            ...
            expect(() => validateKey('test.123.key', 'testKey')).not.toThrow()
            expect(() =>
                validateKey('My.Project.Key', 'testKey', false),
            ).toThrow()
            expect(() =>
                validateKey('UPPER.CASE.KEY', 'testKey', true),
            ).not.toThrow()
        })

        test('should accept keys with mixed valid special characters', () => {
            expect(() =>
                validateKey('my-project_key.v1', 'testKey'),
            ).not.toThrow()
            expect(() =>
                validateKey('test_123-key.prod', 'testKey'),
            ).not.toThrow()
            expect(() =>
                validateKey('My-Project_Key.V1', 'testKey', false),
            ).toThrow()
            expect(() =>
                validateKey('UPPER-CASE_KEY.V2', 'testKey', true),
            ).not.toThrow()
        })
        ...
        test('should enforce capitalization rules for keys with all valid character types', () => {
            ...
            expect(() =>
                validateKey('Project-Key_2024.v1', 'testKey', false),
            ).toThrow()
            expect(() =>
                validateKey('Project-Key_2024.v1', 'testKey', true),
            ).not.toThrow()
        })
    })
    ...
    describe('Error Messages', () => {
        ...
        test('should include the key name in error message for invalid characters', () => {
            expect(() =>
                validateKey('invalid key!', 'sourceProjectKey'),
            ).toThrow('sourceProjectKey contains invalid characters')
            expect(() =>
                validateKey('invalid@key', 'targetProjectKey'),
            ).toThrow('targetProjectKey contains invalid characters')
        })
    })
    ...
    describe('Real-world Examples', () => {
        test('should accept typical project key formats', () => {
            ...
            expect(() =>
                validateKey('dev-environment', 'projectKey'),
            ).not.toThrow()
            expect(() => validateKey('staging_env', 'projectKey')).not.toThrow()
            expect(() => validateKey('test.v1', 'projectKey')).not.toThrow()
            expect(() =>
                validateKey('my-app-prod-2024', 'projectKey'),
            ).not.toThrow()
            expect(() =>
                validateKey('TEST-PROJECT-KEY', 'projectKey', true),
            ).not.toThrow()
        })
        ...
        test('should accept keys with version numbers', () => {
            ...
            expect(() =>
                validateKey('service-1.2.3', 'projectKey'),
            ).not.toThrow()
        })
        ...
        test('should accept mixed case real-world examples', () => {
            expect(() =>
                validateKey('MyCompany-Production', 'projectKey', true),
            ).not.toThrow()
            expect(() =>
                validateKey('TestEnv_2024', 'projectKey', false),
            ).toThrow()
            expect(() =>
                validateKey('TestEnv_2024', 'projectKey', true),
            ).not.toThrow()
            expect(() =>
                validateKey('App.v1.Release', 'projectKey', false),
            ).toThrow()
            expect(() =>
                validateKey('App.v1.Release', 'projectKey', true),
            ).not.toThrow()
        })
    })
})
